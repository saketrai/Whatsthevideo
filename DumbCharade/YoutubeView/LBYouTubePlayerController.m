...
-(id)initWithLocalYoutubeVideo:(NSMutableData*)videoData
{
    self = [super init];
    if (self)
    {
        ...
        [self.extractor startExtractingWithVideoData:videoData];
    }
    return self;
}
...
-(void)youTubeExtractor:(LBYouTubeExtractor *)extractor didSuccessfullyExtractYouTubeURL:(NSURL *)videoURL {
    [self _didSuccessfullyExtractYouTubeURL:videoURL data:nil];
